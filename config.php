...
// GENERAL SETTINGS \\
define('SERVER_SHORT_NAME', 'WWCRP');
define('PENAL_CODE_LINK', 'https://docs.google.com/spreadsheets/d/1rjFI7b86iNpTxcVFsGvghnnBtS2OPvlSA74Y_IBEcEQ/edit#gid=0'); // # to Disable
